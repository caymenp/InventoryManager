...
/**
 * This class handles the modification of an existing part component. This class also handles the form attributes changing
...
public class ModifyPartController implements Initializable {
     ...
     */
    public void partSceneToggle(boolean switched) {
        if (switched){
    ...
    public void partTypeToggle(ActionEvent actionEvent) {
 ...
 */
        ...
        int index = partID;
        Part partToUpdate = InventoryModel.lookupPart(index);
        int indexOf = InventoryModel.getAllParts().indexOf(partToUpdate);

        InventoryModel.updatePart(indexOf, passedInPart);
    ...
    private Part passedInPart;
    public void getPart(Part passedPart) {
        partID.setText(String.valueOf(passedPart.getId()));
        addPartName.setText(String.valueOf(passedPart.getName()));
        addPartInv.setText(String.valueOf(passedPart.getStock()));
        AddPartMax.setText(String.valueOf(passedPart.getMax()));
        AddPartMin.setText(String.valueOf(passedPart.getMin()));
        AddPartPrice.setText(String.valueOf(passedPart.getPrice()));

        if (passedPart instanceof InhouseModel) {
            machineIDpartForm.setText(String.valueOf(((InhouseModel) passedPart).getMachineID()));
        } else if (passedPart instanceof OutsourcedModel) {
            partSceneToggle(false);
            companyNameFormPart.setText(String.valueOf(((OutsourcedModel)passedPart).getCompanyName()));
        }
        passedInPart = passedPart;
    }
